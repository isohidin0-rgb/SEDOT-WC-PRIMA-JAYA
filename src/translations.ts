...
export const translationData = {
  id: {
    ...
    // Call Back translations
    navCallBack: "Minta Call Back",
    callBackLabel: "Penjadwalan Telepon Balik",
    callBackTitle: "PILIH JADWAL TELEPON BALIK",
    callBackDesc: "Punya pertanyaan atau ingin booking cepat? Atur tanggal & slot waktu pilihan Anda di bawah ini, tim kami akan menelepon Anda kembali tepat waktu secara GRATIS!",
    callBackNameLabel: "Nama Lengkap *",
    callBackNamePlaceholder: "Masukkan nama Anda",
    callBackPhoneLabel: "Nomor Telepon / WhatsApp *",
    callBackPhonePlaceholder: "Contoh: 081234567890",
    callBackDateLabel: "Pilih Tanggal Pengerjaan *",
    callBackTimeSlotLabel: "Pilih Slot Waktu Telepon *",
    callBackServiceLabel: "Layanan yang Diperlukan",
    callBackNotesLabel: "Keluhan Tambahan (Opsional)",
    callBackNotesPlaceholder: "Tuliskan keluhan atau instruksi tambahan di sini...",
    callBackSubmitBtn: "Kirim Permintaan Call Back",
    callBackSuccessTitle: "Permintaan Call Back Berhasil!",
    callBackSuccessDesc: "Data Anda berhasil kami catat. Jadwal Anda disimpan secara lokal dan diteruskan ke sistem kami. Tim kami akan segera menghubungi Anda di slot waktu pilihan Anda!",
    callBackListHeader: "Daftar Call Back Saya",
    callBackListEmpty: "Belum ada jadwal Call Back aktif. Silakan isi form di atas!",
    callBackStatusPending: "Menunggu Hubungan",
    callBackStatusConfirmed: "Telah Dikonfirmasi",
    callBackCancelBtn: "Batalkan",
    callBackPreferredLabel: "Metode Kontak Pilihan",
    callBackMethodWa: "WhatsApp Chat",
    callBackMethodCall: "Telepon Langsung",
  },
  en: {
    // Brand / general
    companyName: "PRIMA JAYA",
    ...
    // Call Back translations
    navCallBack: "Request Call Back",
    callBackLabel: "Schedule Call Back",
    callBackTitle: "BOOK A CALL BACK APPOINTMENT",
    callBackDesc: "Have questions or want a quick booking? Pick your preferred date & time slot below, and our team will call you back right on time for FREE!",
    callBackNameLabel: "Full Name *",
    callBackNamePlaceholder: "Enter your full name",
    callBackPhoneLabel: "Phone / WhatsApp Number *",
    callBackPhonePlaceholder: "Example: 081234567890",
    callBackDateLabel: "Select Preferred Date *",
    callBackTimeSlotLabel: "Select Preferred Time Slot *",
    callBackServiceLabel: "Required Service",
    callBackNotesLabel: "Additional Notes (Optional)",
    callBackNotesPlaceholder: "Write down any complaints or instructions here...",
    callBackSubmitBtn: "Request Call Back Now",
    callBackSuccessTitle: "Call Back Requested Successfully!",
    callBackSuccessDesc: "Your request has been captured effectively! It is stored locally on this device and dispatched. Our team will contact you in your selected time slot!",
    callBackListHeader: "My Scheduled Call Backs",
    callBackListEmpty: "No active call backs scheduled yet. Fill out the form above to book!",
    callBackStatusPending: "Pending Contact",
    callBackStatusConfirmed: "Confirmed Appointment",
    callBackCancelBtn: "Cancel",
    callBackPreferredLabel: "Preferred Contact Method",
    callBackMethodWa: "WhatsApp Chat",
    callBackMethodCall: "Direct Phone Call",
  }
};
